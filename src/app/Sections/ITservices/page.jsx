...
import { Building2, Cctv, CheckCircle, Code, House, Palette, PenTool, Podcast, PresentationIcon, Projector, ShoppingCart, Users, Wifi } from "lucide-react";
  ...
  return (
    <main className="p-[5%] flex flex-col items-center gap-12">
      <div className="flex flex-col gap-1 items-center">
        <h2 className="sub_heading yellow"><span className="blue">IT</span>Services</h2>
        <p className="sub_point blue xl:w-[60%] text-center">
          Empowering businesses with cutting-edge technology solutions to drive growth and innovation in the digital era.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
        ...
        {features.map(({ id, icon, title, description }) => (
          <div key={id} className="relative  itservices_card sm:col-span-1 flex flex-col items-center yellow">
            <div className="w-20 h-20 p-3 rounded-[50%] flex justify-center items-center"><span>{icon}</span></div>
            ...
            <div className="service_card_hover w-full h-[110%] absolute  flex justify-center items-center yellow-bg">
              <Button className="border-none yellow-bg text-white px-6 rounded-md font-bold text-2xl">Hire us<FaLongArrowAltRight />
              </Button>
            </div>
          </div>
